...
func Defaults() Config {
	return Config{
		...
		Rules: []Rule{
			...
			{ID: "preset-text", Enabled: Bool(false), Kinds: []string{"file"}, Match: Match{Extensions: []string{".txt", ".md", ".rst", ".csv", ".tsv", ".json", ".yaml", ".yml", ".xml", ".toml", ".ini", ".log"}}, Category: "text", Preset: true},
			...
			{ID: "preset-code", Enabled: Bool(false), Kinds: []string{"file"}, Match: Match{Extensions: []string{".go", ".py", ".js", ".ts", ".java", ".c", ".cpp", ".rb", ".php", ".rs", ".swift", ".bat", ".sh", "ps1"}}, Category: "code", Preset: true},
		},
	}
}
